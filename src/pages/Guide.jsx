import { ArrowRight, CheckCircle2, ClipboardList, Compass, FolderSearch, FolderTree, GitCompare, History, MousePointer2, MousePointerClick, RotateCcw, ShieldCheck, SquareCode, SlidersHorizontal, Timer, Wand2, Workflow } from 'lucide-react';
...
const steps = [
  ...
  {
    title: 'Replay render behavior',
    text: 'Use Replay Debugger to step through events, state updates, renders, wasted work, and accumulated cost over time.',
  },
  {
    title: 'Generate review evidence',
    text: 'Use Advanced Review Hub to inspect the smell radar, summarize saved scenarios, and copy a PR-ready architecture review.',
  },
  {
...
const controls = [
  ...
  { icon: History, label: 'Replay Debugger', text: 'Play, pause, scrub, and export a step-by-step replay of bad vs good render cascades.' },
  { icon: ShieldCheck, label: 'Advanced Review Hub', text: 'Combines smell radar, saved scenario dashboard, and a copyable PR architecture review.' },
    ...
    <div className="space-y-5">
      <section className="panel p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Button variant="secondary" asChild>
            <Link to="/replay-debugger">Replay renders</Link>
          </Button>
          <Button variant="secondary" asChild>
            <Link to="/advanced-review">Advanced review</Link>
          </Button>
          <Button variant="secondary" asChild>
      ...
      <Card>
        ...
        <div className="mt-4 grid gap-3 text-sm text-slate-300 md:grid-cols-2 xl:grid-cols-4">
          ...
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/replay-debugger">8. Replay Debugger</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/advanced-review">9. Advanced Review Hub</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/architecture-workbench">10. Architecture Workbench</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/what-if-studio">11. What If Studio</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/before-after">12. Before vs After</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/export-report">13. Export Report</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/scenario-builder">14. Scenario Builder</Link>
          <Link className="rounded-lg border border-white/10 bg-white/[0.04] p-4 transition hover:border-primary/40 hover:text-primary" to="/advisor-suite">15. Advisor Suite</Link>
        </div>
      </Card>
    </div>
  );
